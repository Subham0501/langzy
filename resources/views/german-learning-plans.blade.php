...
<head>
    ...
    @include('components.seo-meta', [
        'title' => 'German Learning Plans - Language Class & Exam Preparation | Langzy',
        'description' => 'Choose your German learning plan at Langzy. Language classes from A1 to B2 level with comprehensive curriculum, or exam preparation classes for Goethe certification.',
        'keywords' => 'German learning plans, German language class, German exam preparation, A1 German, A2 German, B1 German, B2 German, Goethe exam, German course pricing',
        'image' => asset('Group 36.png'),
        'url' => url('/german-learning-plans'),
        'type' => 'website',
        'canonical' => url('/german-learning-plans')
    ])
...
<body class="font-inter">
    ...
    <section class="py-24 bg-gradient-to-br from-langzy-blue via-blue-500 to-blue-600 relative overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10">
            ...
            <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight">Choose Your German Learning Plan</h1>
            <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed">
                Master German with our comprehensive courses designed for all proficiency levels
            </p>
        </div>
    </section>
