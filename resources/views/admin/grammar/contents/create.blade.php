                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div>
                        ...
                        <select id="language" 
                                ...
                                required
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-langzy-blue focus:border-transparent">
                            <option value="german" {{ old('language', $selectedLanguage ?? 'german') === 'german' ? 'selected' : '' }}>German</option>
                            <option value="french" {{ old('language', $selectedLanguage ?? 'german') === 'french' ? 'selected' : '' }}>French</option>
                        </select>
                        @error('language')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
